...
<head>
  ...
  <title>SiHD / Cetak Form Assesment Tier 1</title>
  <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Cetak Form Tier 1 <?php echo $login_session; ?>
		...
		<button class="btn btn-info" onclick="cetak1a()"><i class="fa fa-print"></i> Blanko Pengukuran Beban&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>				  		
 </div>
		<div class="form-group col-md-3 col-sm-3">
		<button class="btn btn-info" onclick="cetak1b()"><i class="fa fa-print"></i> Blanko Inspeksi Visual&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>				  		
                  </div> </div>
...
if (!$result) {
 ...
 ' <table class="table" id="dataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
					...
					<th>Kapasitas</th>
					<th>Fasa</th>
					<th><center>Pengukuran Beban</center></th>
					<th><center>Inspeksi Visual</center></th>
                </tr>
              </thead>
              <tfoot>
                <tr>
 ...
 echo '  
                             <tr>  <td>'.$no.'</td>
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>  
 	<td><center><a data-target="#cetakt1a" class="btn btn-info btn-circle" data-title="Cetak" data-toggle="modal" data-id="'.base64_encode(342342342*$row["idgardu"]).'"><i class="fa fa-print" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#cetakt1b" class="btn btn-info btn-circle" data-title="Cetak" data-toggle="modal" data-id="'.base64_encode(342342342*$row["idgardu"]).'"><i class="fa fa-print" style="color:#fff"></i></a></center></td>																	  
...
<div class="modal fade" id="modChangePw" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
		    ...
		    <!-- Cetak Tier 1 Pengukuran Beban Modal-->

	    <div class="modal fade" id="cetakt1a" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="cetak1a-data"> 
	...
	<!-- Cetak Tier 1 Inspeksi Visual-->
	    <div class="modal fade" id="cetakt1b" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="cetak1b-data"> 
...
function cetak1a(){
window.open("blanko1a.php", "page","toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes")
}
</script>
...
var s5_taf_parent = window.location;
function cetak1b(){
window.open("blanko1b.php", "page","toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes")
}
</script>
