...
<table width="760"  border="1" cellspacing="0" cellpadding="0">
  <tr align="center" valign="middle">
    <td height="22" colspan="6"><font color="#4f5051"><strong><span class="style2">DAFTAR ASSESMENT TIER 1 - INSPEKSI VISUAL </span></strong></font></td>
    </tr>
  <tr>
  ...
  <?php
$kueri="SELECT*
FROM t1b WHERE kodegd ='$kodegd' AND status=1 ORDER by tgl DESC LIMIT 6" ;
$no=1;
...
if (!$hasil) {
 ...
 $id_t1b=190991*$kali*$brs["id_t1b"];  
  $kalik = base64_encode(13532*$kali);
 echo '  
  <tr>
    <td width="50"> <font color="#4f5051">&nbsp;&nbsp;'.$no.'</font> </td> 
    <td width="120">  <font color="#4f5051"><center><a href="#" onclick=JavaScript:view("../tier1/detail_b.php?id='.base64_encode(24021995*$kali*$id).'&assesment='.base64_encode($id_t1b).'&log='.$kalik.'")>'.$brs["kodegd"].'</a></center></font> </td>
