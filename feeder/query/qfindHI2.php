<?php
   ...
   $ass = $_POST['ass'];  
   $hi = $_POST['hi'];
	if ($ass==1){$asse='hi_2a_oil';}
		else if ($ass==2){$asse='hi_bdv';}
			else if ($ass==3){$asse='hi_2b';}
				else {$asse='hi_2b_body';}
				
		if ($ass==1){$asses='Oil Colour';}
		else if ($ass==2){$asses='BdV';}
			else if ($ass==3){$asses='Body Trafo';}
				else {$asses='Suhu Komponen';}		
