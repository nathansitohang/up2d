...
<head>
  ...
  <title>SiHD / Kuisioner SIMKPNAS</title>
  <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Kuisionoer 
...
$query="SELECT*
FROM sn_tmst_questioner2 JOIN sn_tmst_questioner_detail2 ON sn_tmst_questioner2.id = sn_tmst_questioner_detail2.id_group" ;
$result = mysqli_query($db, $query);
if (!$result) {
  die('Invalid query: ' . mysqli_error());
}
