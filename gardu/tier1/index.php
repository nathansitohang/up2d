...
if (!$result) {
 ...
 echo '  
                             <tr>
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>  
 	<td><center><a data-target="#modViewt1a" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#modViewt1b" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(891234567*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></center></td>																	  
...
if (!$result) {
 ...
 echo '  
                             <tr>  
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>
	<td><center><a data-target="#modViewt1a" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a>&nbsp&nbsp<a data-target="#modInTier1a" class="btn btn-success btn-circle" data-title="Update" data-toggle="modal" data-id="'.base64_encode(89189218*$kali*$row["idgardu"]).'"><i class="fa fa-pencil" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#modViewt1b" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(891234567*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a>&nbsp&nbsp<a data-target="#modInTier1b" class="btn btn-success btn-circle" data-title="Update" data-toggle="modal" data-id="'.base64_encode(289182189*$kali*$row["idgardu"]).'"><i class="fa fa-pencil" style="color:#fff"></i></a></center></td>																	  
                               </tr>  
                               ';	
	}
...
<div class="modal fade" id="modChangePw" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="modLogout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
	    ...
	    <div class="modal fade" id="modViewt1a" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="lihatT1a-data"> 
