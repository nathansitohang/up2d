<?php
	...
	include('../../session.php');
		if (!empty($_GET['assesment']) && !empty($_GET['id']) && base64_decode($_GET['log'])/13532 == $kali) {
	 	$id_t2b= base64_decode($_GET['assesment']);  
		$id_t2b= $id_t2b/(190991*$kali);	
		$kuery = "SELECT * FROM t2b WHERE id_t2b = $id_t2b";
...
<head>
  ...
  <title>Detail Thermovision</title>
  <!-- Bootstrap core CSS-->
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
...
<div >
      <div class="breadcrumb mb-3"  style="width: 50rem;" id="cetakini">
...
<br/>
   ...
   <div class="table-responsive">
      <table  width="400" border="0" cellspacing="0" cellpadding="0">
         <tr>
         <td height="22" colspan="4"><font color="#4f5051"><strong><span class="style2">HASIL ASSESMENT TIER 2 - THERMOVISION</span></strong></font></td>
         </tr>
      </table>
...
<td colspan="3">&nbsp;&nbsp;<?php echo $baris['ptgs']; ?></td>
</tr>
<tr>
<td>&nbsp;&nbsp;Tanggal Assesment</td>
<td colspan="3">&nbsp;&nbsp;<?php echo $baris['tgl']; ?></td>
</tr>
<tr>
<td>&nbsp;&nbsp;Suhu Lingkungan</td>
<td colspan="3">&nbsp;&nbsp;<?php echo $baris['amb']; ?> &#8451;</td>
</tr>
<tr align="center">
<th colspan="2"  width="350"><font color="#4f5051"><strong>Thermovision Trafo</strong></th>
<th colspan="2"  width="350"><font color="#4f5051"><strong>Thermovision PHB-TR</strong></th>
</tr>
<tr align="center">
<td  width="175"><font color="#4f5051">Incoming FCO</td>
<td  width="175"><font color="#4f5051"><?php echo $baris['incfco']; ?> &#8451;</td>
<td width="175"><font color="#4f5051">Kabel Incoming</td>
<td width="175"><font color="#4f5051"><?php echo $baris['opsinc']; ?> &#8451;</td>
</tr>
<tr align="center">
<td ><font color="#4f5051">Outgoing FCO</td>
<td ><font color="#4f5051"><?php echo $baris['outfco']; ?> &#8451;</td>
<td ><font color="#4f5051">Kabel Outgoing</td>
<td ><font color="#4f5051"><?php echo $baris['opsout']; ?> &#8451;</td>
</tr>
<tr align="center">
<td ><font color="#4f5051">Body Trafo</td>
<td ><font color="#4f5051"><?php echo $baris['bodyt']; ?> &#8451;</td>
<td ><font color="#4f5051">NT Fuse Holder</td>
<td ><font color="#4f5051"><?php echo $baris['ntholder']; ?> &#8451;</td>
</tr>
<tr align="center">
<td ><font color="#4f5051">Bushing Primer</td>
<td ><font color="#4f5051"><?php echo $baris['bushtm']; ?> &#8451;</td>
<td ><font color="#4f5051">Sepatu Kabel</td>
<td ><font color="#4f5051"><?php echo $baris['skun']; ?> &#8451;</td>
</tr>
<tr align="center">
<td ><font color="#4f5051">Bushing Sekunder</td>
<td ><font color="#4f5051"> <?php echo $baris['bushtr']; ?> &#8451;</td>
<td ><font color="#4f5051">Konektor ke JTR</td>
<td ><font color="#4f5051"><?php echo $baris['conn']; ?> &#8451;</td>
</tr>
</table>
