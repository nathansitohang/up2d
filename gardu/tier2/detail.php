<?php
	...
	include('../../session.php');
		if (!empty($_GET['assesment']) && !empty($_GET['id']) && base64_decode($_GET['log'])/13532 == $kali) {
	 	$id_t2a= base64_decode($_GET['assesment']);  
		$id_t2a= $id_t2a/(190991*$kali);	
		$kuery = "SELECT * FROM t2a WHERE id_t2a = $id_t2a";
...
<br/>
   ...
   <div class="table-responsive">
      <table  width="400" border="0" cellspacing="0" cellpadding="0">
         <tr>
         <td height="22" colspan="4"><font color="#4f5051"><strong><span class="style2">HASIL ASSESMENT TIER 2 - UJI KUALITAS MINYAK</span></strong></font></td>
         </tr>
      </table>
...
<tr align="center">
<th ><font color="#4f5051"><strong>Warna minyak trafo</strong></th>
<th ><font color="#4f5051"><strong>Tegangan tembus</strong></th>
</tr>
 <tr valign="middle" >
 <td>&nbsp;&nbsp;<input type="radio" name="oil" id="radio1" <?php if ($baris['oil'] == '4') { echo "checked"; } ?> disabled />
            <label for="radio1">Jernih</label></td>
 <td rowspan="4" valign="middle" align="center"><?php echo $baris['bdv']; ?>&nbsp;kV/2.5 mm</td>
 </tr>
 <tr valign="middle" >
 <td>&nbsp;&nbsp;<input type="radio" name="oil" id="radio2" <?php if ($baris['oil'] == '3') { echo "checked"; } ?> disabled />
            <label for="radio2">Keruh</label></td>
 
  </tr>
 <tr valign="middle" >
 <td>&nbsp;&nbsp;<input type="radio" name="oil" id="radio3" <?php if ($baris['oil'] == '2') { echo "checked"; } ?> disabled />
            <label for="radio3">Keruh Gelap</label></td>
 </tr>
 <tr valign="middle" >
 <td>&nbsp;&nbsp;<input type="radio" name="oil" id="radio4" <?php if ($baris['oil'] == '1') { echo "checked"; } ?> disabled />
            <label for="radio4">Hitam Pekat</label></td>
 </tr>
</table>
