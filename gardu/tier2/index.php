    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Assesment Tier 2 <?php echo $login_session; ?>
...
if (!$result) {
 ...
 echo '  
                             <tr>  <td>'.$no.'</td>
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>  
 	<td><center><a data-target="#modViewt2a" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#modViewt2b" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></center></td>	 
                               </tr>  
                               ';	$no++;
	}
...
if (!$result) {
 ...
 echo '  
                             <tr>  
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>
	<td><center><a data-target="#modViewt2a" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a>&nbsp&nbsp<a data-target="#modInTier2a" class="btn btn-success btn-circle" data-title="Update" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-pencil" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#modViewt2b" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a>&nbsp&nbsp<a data-target="#modInTier2b" class="btn btn-success btn-circle" data-title="Update" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-pencil" style="color:#fff"></i></a></center></td>																	  
                               </tr>  
                               ';	
	}
...
<div class="modal fade" id="modChangePw" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
		   ...
		   <!-- Lihat Tier 2 Oil Quality Analysis-->

	    <div class="modal fade" id="modViewt2a" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="lihatT2a-data"> 
	...
	<!-- Lihat Tier 2 Thermovision-->
	    <div class="modal fade" id="modViewt2b" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="lihatT2b-data"> 
		    ...
		    <!-- Input Tier 2 Oil Quality Analysis-->
    	    <div class="modal fade" id="modInTier2a" role="dialog">
        <div class="modal-dialog modal-xs" role="document">
            <div class="modal-content">
                <div class="InTier2a-data"></div>
            </div>
        </div>
    </div>
	
			    <!-- Input Tier 2 Thermovision-->
    	    <div class="modal fade" id="modInTier2b" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="InTier2b-data"></div>
            </div>
        </div>
    </div>
