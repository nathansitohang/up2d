...
<head>
  ...
  <title>SiHD / Cetak Form Form Assesment Tier 3</title>
  <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Cetak Form Tier 3 <?php echo $login_session; ?>
		...
		<button class="btn btn-info" onclick="cetak3a()"><i class="fa fa-print"></i> Blanko TTR Test&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>				  		
 </div>
		<div class="form-group col-md-3 col-sm-3">
		<button class="btn btn-info" onclick="cetak3b()"><i class="fa fa-print"></i> Blanko Ukur Tahanan Isolasi&nbsp&nbsp&nbsp</button>				  		
                  </div> 
				  		<div class="form-group col-md-3 col-sm-3">
		<button class="btn btn-info" onclick="cetak3c()"><i class="fa fa-print"></i> Blanko Ukur Tahanan Belitan&nbsp&nbsp</button>				  		
                  </div>
				  </div>
...
if (!$result) {
 ...
 echo '  
                             <tr>  <td>'.$no.'</td>
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>  
	<td><center><a data-target="#cetakt3a" class="btn btn-info btn-circle" data-title="Cetak" data-toggle="modal" data-id="'.base64_encode(4324234*$row["idgardu"]).'"><i class="fa fa-print" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#cetakt3b" class="btn btn-info btn-circle" data-title="Cetak" data-toggle="modal" data-id="'.base64_encode(4324234*$row["idgardu"]).'"><i class="fa fa-print" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#cetakt3c" class="btn btn-info btn-circle" data-title="Cetak" data-toggle="modal" data-id="'.base64_encode(4324234*$row["idgardu"]).'"><i class="fa fa-print" style="color:#fff"></i></a></center></td>																	    
                               </tr>  
                               ';	$no++;
	}
...
<div class="modal fade" id="modChangePw" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="modLogout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  ...
	  <!-- Cetak Tier 3 TTR-->
	    ...
	    <div class="modal fade" id="cetakt3a" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="cetak3a-data"> 
	...
	<!-- Cetak Tier 3 Megger-->
	    <div class="modal fade" id="cetakt3b" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="cetak3b-data"> 
		...
		<!-- Cetak Tier 3 WR-->
	    <div class="modal fade" id="cetakt3c" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="cetak3c-data"> 
...
function cetak3a(){
window.open("blanko3a.php", "page","toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes")
}
</script>
...
var s5_taf_parent = window.location;
function cetak3b(){
window.open("blanko3b.php", "page","toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes")
}
</script>
...
var s5_taf_parent = window.location;
function cetak3c(){
window.open("blanko3c.php", "page","toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes")
}
</script>
