...
, SUM((YEAR(tgl1) = '$tahunini' AND MONTH(tgl1) = '11') OR (YEAR(tgl2) = '$tahunini' AND MONTH(tgl2) = '11')) AS 'nop'
, SUM((YEAR(tgl1) = '$tahunini' AND MONTH(tgl1) = '12') OR (YEAR(tgl2) = '$tahunini' AND MONTH(tgl2) = '12')) AS 'des'
									from t1a WHERE idrayon ='$login_idrayon'");
	} 
	    $data=mysqli_fetch_assoc($result);
		$data2=mysqli_fetch_assoc($result2);
    $totgd = $data['total'];
	$kondisikurang = $data['kondisikurang'];
	$kondisiburuk = $data['kondisiburuk'];
	$baik = $data['baik'];
    $cukup = $data['cukup'];
	$kurang = $data['kurang'];
    $buruk = $data['buruk'];
   ...
   <head>
      ...
      <link href="..//css/sb-admin.css" rel="stylesheet">
	      <link href="../css/button/buttons.dataTables.min.css" rel="stylesheet">
	        <script src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=true&amp;key=AIzaSyAXmbhRDK2Lq3eaEIUzif4KHkMxt_tadF0" type="text/javascript"></script>
               ...
               <div class="col-xl-3 col-sm-6 mb-3">
                  <div class="card text-white bg-warning o-hidden h-100">
                     <div class="card-body">
                        ...
                        <div class="mr-5"><?php echo $kondisikurang; ?>  Gardu Kurang Baik</div>
                     </div>
               ...
               <div class="col-xl-3 col-sm-6 mb-3">
                  <div class="card text-white bg-danger o-hidden h-100">
                     <div class="card-body">
                        ...
                        <div class="mr-5"><?php echo $kondisiburuk; ?>  Gardu Segera Perbaiki</div>
                     </div>
