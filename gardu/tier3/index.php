...
<head>
  ...
  <title>SiHD / Assesment Gardu</title>
  <!-- Bootstrap core CSS-->
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Assesment Tier 3 <?php echo $login_session; ?>
...
if (!$result) {
 ...
 ' <table class="table" id="dataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
					...
					<th>Kapasitas</th>
					<th>Fasa</th>
					<th><center>Turn Ratio Measurement</center></th>
					<th><center>Insulation Resistance</center></th>
					<th><center>Winding Resistance</center></th>
                </tr>
              </thead>
              <tfoot>
                <tr>
 ...
 echo '  
                             <tr>  <td>'.$no.'</td>
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>  
	<td><center><a data-target="#modViewt3a" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#modViewt3b" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#modViewt3c" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></center></td>																	    
                               </tr>  
                               ';	$no++;
	}
...
if (!$result) {
 ...
 echo '  
                             <tr>  
                                    ...
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>
	<td><center><a data-target="#modViewt3a" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a>&nbsp&nbsp<a data-target="#modInTier3a" class="btn btn-success btn-circle" data-title="Update" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-pencil" style="color:#fff"></i></a></center></td>																	  
	<td><center><a data-target="#modViewt3b" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a>&nbsp&nbsp<a data-target="#modInTier3b" class="btn btn-success btn-circle" data-title="Update" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-pencil" style="color:#fff"></i></a></center></td>																	  
    <td><center><a data-target="#modViewt3c" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-eye" style="color:#fff"></i></a>&nbsp&nbsp<a data-target="#modInTier3c" class="btn btn-success btn-circle" data-title="Update" data-toggle="modal" data-id="'.base64_encode(78484899*$kali*$row["idgardu"]).'"><i class="fa fa-pencil" style="color:#fff"></i></a></center></td>																	                            
							   </tr>  
                               ';	
	}
...
<div class="modal fade" id="modChangePw" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="modLogout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
	   ...
	   <!-- Lihat Tier 3 TTR-->
	    ...
	    <div class="modal fade" id="modViewt3a" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="lihatT3a-data"> 
	...
	<!-- Lihat Tier 3 Megger-->
	    <div class="modal fade" id="modViewt3b" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="lihatT3b-data"> 
		...
		<!-- Lihat Tier 3 Winding Resistance-->
	    <div class="modal fade" id="modViewt3c" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="lihatT3c-data"> 
		    ...
		    <!-- Input Tier 3 TTR-->
    	    <div class="modal fade" id="modInTier3a" role="dialog">
        <div class="modal-dialog modal-xs" role="document">
            <div class="modal-content">
                <div class="InTier3a-data"></div>
            </div>
        </div>
    </div>
	
			    <!-- Input Tier 3 Insulation Resistance-->
    	    <div class="modal fade" id="modInTier3b" role="dialog">
        <div class="modal-dialog modal-xs" role="document">
            <div class="modal-content">
                <div class="InTier3b-data"></div>
            </div>
        </div>
    </div>
	
	
				    <!-- Input Tier 3 Winding Resistance-->
    	    <div class="modal fade" id="modInTier3c" role="dialog">
        <div class="modal-dialog modal-xs" role="document">
            <div class="modal-content">
                <div class="InTier3c-data"></div>
            </div>
        </div>
    </div>
