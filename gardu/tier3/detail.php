<?php
	...
	include('../../session.php');
		if (!empty($_GET['assesment']) && !empty($_GET['id']) && base64_decode($_GET['log'])/13532 == $kali) {
	 	$id_t3a= base64_decode($_GET['assesment']);  
		$id_t3a= $id_t3a/(190991*$kali);	
		$kuery = "SELECT * FROM t3a WHERE id_t3a = $id_t3a";
...
<br/>
   ...
   <div class="table-responsive">
      <table  width="400" border="0" cellspacing="0" cellpadding="0">
         <tr>
         <td height="22" colspan="4"><font color="#4f5051"><strong><span class="style2">HASIL ASSESMENT TIER 3 - TTR </span></strong></font></td>
         </tr>
      </table>
	  <table width="700"  border="1" cellspacing="0" cellpadding="0">
<tr>
...
<td width="175"><font color="#4f5051"><?php echo $baris['tap1a']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap1b']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap1c']; ?></td>
</tr>
<tr align="center">
<td width="175"><font color="#4f5051"><strong>Tap 2</strong></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap2a']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap2b']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap2c']; ?></td>
</tr>
<tr align="center">
<td width="175"><font color="#4f5051"><strong>Tap 3</strong></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap3a']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap3b']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap3c']; ?></td>
</tr>
<tr align="center">
<td width="175"><font color="#4f5051"><strong>Tap 4</strong></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap4a']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap4b']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap4c']; ?></td>
</tr>
<tr align="center">
<td width="175"><font color="#4f5051"><strong>Tap 5</strong></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap5a']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap5b']; ?></td>
<td width="175"><font color="#4f5051"><?php echo $baris['tap5c']; ?></td>
</tr>
</table> 
   </div>
   </div>
