...
<html lang="en">
   <head>
      ...
      <title>SiODis / Entri Beban</title>
      <!-- Bootstrap core CSS-->
   ...
   <body class="fixed-nav sticky-footer bg-dark" id="page-top">
      ...
      <div class="content-wrapper">
         <div class="container-fluid">
            ...
            <div class="card mb-3">
               <div class="card-header">
                  <i class="fa fa-table"></i> Entri Data Beban Penyulang <?php echo $namalogin; ?></a>
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     ...
                     <?php
                        ...
                        if ($login_role == "admin") {
                       $query="SELECT*
                        FROM titik WHERE KODE_ASET =1 order by KODE_UP" ;
                        ...
                        if (!$result) {
                         ...
                         echo '  
                                                     <tr>
                        					<td>'.$no.' </td>																							 
                        	<td><p data-placement="top" data-toggle="tooltip" title="Lihat"><a data-target="#modBeban" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(657454*$row["NO"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></p></td>
                         ...
                         ' <table class="table" id="dataFeed" width="100%" cellspacing="0">
                          ...
                          while ($row = @mysqli_fetch_assoc($result)){
							  ...
							  if ($row["kode_aset"] == 1) {$asal = "";}
								...
								$bebana= 0.95*1000*$row["mva"]/(20*sqrt(3));
							 
                         echo '  
                                                     <tr>
                        					<td>'.$no.' </td>																							 
                        	<td><p data-placement="top" data-toggle="tooltip" title="Lihat"><a data-target="#modView1" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(657454*$row["no"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></p></td>
         ...
         <!-- Lihat Data Beban Modal Test-->
         <div class="modal fade" id="modBeban" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  <div class="lihatBeban-data"> 
                  </div>
               </div>
            </div>
         </div>
