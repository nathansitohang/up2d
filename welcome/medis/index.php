...
<html lang="en">
   <head>
      ...
      <title>SiHD / Master Penyulang</title>
      <!-- Bootstrap core CSS-->
            ...
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
               ...
               <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Assesment">
                  ...
                  <ul class="sidenav-second-level collapse" id="assesment">
                     <li>
                        <a href="../setpro">Setting Proteksi</a>
                     </li>
                     <li>
                        <a href="../medis">Data Gangguan</a>
                     </li>
                     <li>
                        <a href="../beban">Data Beban</a>
                     </li>
                  </ul>
               </li>
         ...
         <div class="container-fluid">
            ...
            <div class="card mb-3">
               <div class="card-header">
                  <i class="fa fa-table"></i> Data Penyulang di <?php echo $login_area; ?></a>
