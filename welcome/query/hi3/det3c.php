...
<table width="400" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td valign="top" class="menuUtamaOff">Wilayah Sumatera Utara<br>Area&nbsp<?php echo $row['area']; ?> <br>Rayon&nbsp<?php echo $row['rayon']; ?> </td> 
		...
		<?php
		$show1 = mysqli_query($db, "SELECT * FROM `t3c` WHERE `kodegd` = '$kodegd' ORDER by `tgl` DESC LIMIT 1 ");
...
<td colspan="7">&nbsp;&nbsp;<?php echo $baris['tgl']; ?></td>
  ...
  <tr align="center">
    <td class="nol" height="100"><?php echo $baris['p1']; ?></td>
    <td class="nol"><?php echo $baris['p2']; ?></td>
    <td class="nol"><?php echo $baris['p3']; ?></td>
  </tr>
  <tr align="center">
  ...
  <tr align="center">
    <td class="nol" height="100"><?php echo $baris['s1']; ?></td>
    <td class="nol"><?php echo $baris['s2']; ?></td>
    <td class="nol"><?php echo $baris['s3']; ?></td>
  </tr>
</table><br/>
<table width="760"  border="1" cellspacing="0" cellpadding="0">
<tr align="center">
