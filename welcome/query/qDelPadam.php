			...
			<div class="form-bottom">
			  ...
			  <div class = "row">
                  ...
                  <div class="form-group col-md-12 col-sm-3">
			   	...
			   	<input type="hidden" class="form-control" id="jenispadam"  value="<?php echo $jenispadam;?>" >
		<input type="hidden" class="form-control" id="katapadam"  value="<?php echo $katapadam;?>" >
            ...
            <div class="form-bottom">
               <table  class= "table table-bordered table-hover" width="760" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
                     ...
                     <td width="350"><?php echo $row['gigh']; ?> <?php echo $row['td']; ?>/ <?php echo $row['kap']; ?> MVA </td>
				  ...
				  if ($row['kode_aset']== 2){
                     ...
                     <td width="250"><font color="#4f5051"><strong>&nbsp;&nbsp;</strong></font></td>
                     <td width="200"></td>
                  </tr>
					  ';
...
<script>
function InsertPadam(){if(1==confirm("Apakah Anda yakin untuk menyimpan data?")){
...
function(a){$("#modView").modal("hide"),alert("Data berhasil diubah!"),location.href="../padam"}):alert("Anda tidak memiliki hak akses untuk mengubah data")}}
</script>