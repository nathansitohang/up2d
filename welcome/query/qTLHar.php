...
<div class="card-header text-white bg-success"> <i class="fa fa-plus"></i> Entry Progress Data Pemeliharaan
				...
				<div class="form-bottom">
					<?php
						if ($row['status'] == 1)
						{
							...
							<div class="row">
								<div class="form-group col-md-12 col-sm-12">
									<label for="tipepulih">Penyulang Sudah Pulih Keseluruhan. Sila Masukkan Detail Lengkap Pemeliharaan. ENS = '.$row["ens"].' kWh</label>
						...
						else
						{
							...
							<div class="row">
								<div class="form-group col-md-12 col-sm-12">
									<label for="tipepulih">Event Padam Pemeliharaan Belum Ditindaklanjuti.</label>
								</div>
							</div>
							';
						}						
