...
<div class="card-header"><i class="fa fa-print"  ></i>   Cetak Form Ukur Tahanan Isolasi - <?php echo $row['kodegd']; ?> 
         ...
         <tr>
            <td> &nbsp </td>
               ...
               <table width="750"  border="1" cellspacing="0" cellpadding="0">
			      ...
			      <table width="750"  border="1" cellspacing="0" cellpadding="0">
	           <tr>
         <td height="22" align="center" colspan="8"><font color="#4f5051"><strong><span class="style2">FORMULIR ASSESMENT TIER 3 - PENGUKURAN TAHANAN ISOLASI</span></strong></font></td>
         </tr>
<tr>
