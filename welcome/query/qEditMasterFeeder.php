...
<div class="card-header"><i class="fa fa-eye"  ></i>   Edit Data Penyulang <?php echo $row['feeder']; ?> 
               ...
               <table  class= "table table-bordered table-hover" width="760" border="0" cellspacing="0" cellpadding="0">
				  ...
				  ?>
				   ...
				   <tr>
					 ...
					 <tr>
					 <td width="350" contenteditable='true' style="text-align: center; vertical-align: middle;"colspan="4"><?php echo $row['ket4']; ?></td>
				...
				<input class="btn btn-secondary btn-xs pull-right" type="button" value="Save" id="save">
