...
<html lang="en">
   <head>
      ...
      <title>SiODis / Master Keypoint</title>
      <!-- Bootstrap core CSS-->
         ...
         <div class="container-fluid">
            ...
            <div class="card mb-3">
               <div class="card-header">
                  <i class="fa fa-table"></i> Data Keypoint Tersebar di  <?php echo $namalogin; ?>
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     ...
                     <?php
                        ...
                        if ($login_role == "admin") {
                        $query="SELECT*
                        FROM penyulang WHERE kode_aset IN (6,7,8,9) ORDER BY idup3,idulp " ;
                        ...
                        if (!$result) {
                         ...
                         echo        
                         ' <table class="table" id="dataKP" width="100%" cellspacing="0">
                                      <thead>
                                        <tr>
                        					<th>No</th>
											<th>Detail</th>
                        					<th>Nomor Keypoint</th>
											<th>UP3</th>
											<th>ULP</th>
                        					<th>Section</th>
                        					<th>Penyulang</th>
                         ...
                         echo '  
                                                     <tr>  
															<td>'.$no.'</td>
<td><p data-placement="top" data-toggle="tooltip" title="Lihat"><span><a data-target="#modViewKP" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(657454*$row["no"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></span></p></td>																
                        									<td>'.$row["nmkltr"].'</td>  
                                                            <td>'.$row["up3"].'</td>  
                                                            <td>'.$row["ulp"].'</td>  
															<td>'.$row["section"].'</td>  
...
<td><p data-placement="top" data-toggle="tooltip" title="Edit"><a data-target="#modEditKP" class="btn btn-success btn-circle " data-title="Edit" data-toggle="modal" data-id="'.base64_encode(7238985*$row["no"]).'" ><i class="fa fa-pencil" style="color:#fff"></i></a></p></td>															
                                                       </tr> 
                        ...
                        $query="SELECT*
                        FROM keypoint WHERE idup3='$login_idarea' OR idup32='$login_idarea' ORDER BY idulp1 " ;
                        $result = mysqli_query($db, $query);
                        if (!$result) {
                          die('Invalid query: ' . mysqli_error());
                        }
                        ...
                        if (!$result) {
                         ...
                         echo '  
                        	...
                        	<td><p data-placement="top" data-toggle="tooltip" title="Edit"><a data-target="#modEditKP" class="btn btn-success btn-circle " data-title="Edit" data-toggle="modal" data-id="'.base64_encode(7238985*$row["no"]).'" ><i class="fa fa-pencil" style="color:#fff"></i></a></p></td>
                        	<td><p data-placement="top" data-toggle="tooltip" title="Hapus"><a data-target="#modDeleteKP" class="btn btn-danger btn-circle" data-title="Hapus" data-toggle="modal" data-id="'.base64_encode(4635636*$row["no"]).'"><i class="fa fa-trash" style="color:#fff"></i></a></p></td>																	  
                                                       </tr>  
                                                       '; 
                        	}
         ...
         <div class="modal fade" id="modViewKP" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  <div class="lihatKP-data"> 
                  </div>
               </div>
            </div>
         </div>
         <!-- Edit Data Gardu Modal-->
         <div class="modal fade" id="modEditKP" role="dialog">
            <div class="modal-dialog modal-xs" role="document">
               <div class="modal-content">
                  <div class="editKP-data"></div>
               </div>
            </div>
         </div>
         <!-- Delete Gardu Modal Test-->
         <div class="modal fade" id="modDeleteKP" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  <div class="deleteKP-data"> 
                  </div>
               </div>
            </div>
         </div>
