...
<html lang="en">
   <head>
      ...
      <title>SiODis / Setting Proteksi</title>
      <!-- Bootstrap core CSS-->
         ...
         <div class="container-fluid">
            ...
            <div class="card mb-3">
               <div class="card-header">
                  <i class="fa fa-table"></i> Setting Proteksi di <?php echo $namalogin; ?></a>
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     ...
                     <?php
                        ...
                        if ($login_role == "admin") {
                       $query="SELECT*
                        FROM penyulang WHERE 1 order by kodefgh" ;
...
<th>T</th>								
                         ...
                         echo '  
                                                     <tr>
                        					<td>'.$no.' </td>																							 
                        	<td><p data-placement="top" data-toggle="tooltip" title="Lihat"><a data-target="#modViewProtek" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(657454*$row["no"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></p></td>
														  ...
														  <td>'.$row["gf_tms"].'</td>
                                                            ...
                                                            <td>'.$row["gfi_set"].'</td>  
                                                            <td>'.$row["gfi_t"].'</td> 														
  															<td><p data-placement="top" data-toggle="tooltip" title="Edit"><a data-target="#modReset" class="btn btn-success btn-circle " data-title="Edit" data-toggle="modal" data-id="'.base64_encode(7238985*$row["no"]).'" ><i class="fa fa-pencil" style="color:#fff"></i></a></p></td>  															
...
<td><p data-placement="top" data-toggle="tooltip" title="Edit"><a data-target="#modReset" class="btn btn-success btn-circle " data-title="Edit" data-toggle="modal" data-id="'.base64_encode(7238985*$row["no"]).'" ><i class="fa fa-pencil" style="color:#fff"></i></a></p></td>  															
         ...
         <div class="modal fade" id="modViewProtek" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  <div class="lihatProtek-data"> 
                  </div>
               </div>
            </div>
         </div>
         <!-- Edit Data Gardu Modal-->
         <div class="modal fade" id="modReset" role="dialog">
