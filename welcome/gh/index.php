...
<html lang="en">
   <head>
      ...
      <title>SiODis / Master Gardu Hubung</title>
      <!-- Bootstrap core CSS-->
         ...
         <div class="container-fluid">
            ...
            <div class="card mb-3">
               <div class="card-header">
                  <i class="fa fa-table"></i> Data Gardu Hubung Tersebar di <?php echo $login_area; ?></a>
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     ...
                     <?php
                        ...
                        if ($login_role == "admin") {
                       $query="SELECT*
                        FROM titik WHERE KODE_ASET = 2 ORDER by KODE_UP, KODE_UL" ;
                        ...
                        if (!$result) {
                         ...
                         echo        
                         ' <table class="table" id="dataGH" width="100%" cellspacing="0">
                                      <thead>
                                        <tr>
                         ...
                         echo '  
                        	...
                        	<td><p data-placement="top" data-toggle="tooltip" title="Lihat"><a data-target="#modView1" class="btn btn-warning btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.base64_encode(657454*$row["NO"]).'"><i class="fa fa-eye" style="color:#fff"></i></a></p></td>
                                                            ...
                                                            <td>'.$row["SCADA"].'</td>
                                                            <td>'.$row["MERK_BAT"].' '.$row["TYPE_BAT"].'</td>  
                                                            <td>'.$row["KET"].'</td>  																
                        ...
                        $query="SELECT*
                        FROM titik WHERE KODE_ASET = 2 AND (KODE_UP ='$login_idarea' OR SHARING ='$login_idarea')" ;
                        $result = mysqli_query($db, $query);
                        if (!$result) {
                          die('Invalid query: ' . mysqli_error());
                        }
