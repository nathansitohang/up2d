...
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
         ...
         <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
	            ...
	            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="beban">
					<a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" data-target="#beban" data-parent="#exampleAccordion">
						<i class="fa fa-fw fa-balance-scale"></i> 
						<span class="nav-link-text">Beban</span>
					</a>
					
					
                <ul class="sidenav-second-level collapse" id="beban">
                    <li>
                        <a href="gi">Beban Puncak Bulanan</a>
                    </li>
                     
					<li>
                        <a href="gh">Beban Rata-rata Harian</a>
                    </li>
					
					<li>
                        <a href="feeder">Beban TD</a>
                    </li>
    ...
    <br>
	   ...
	   &nbsp;&nbsp;&nbsp;
        ...
        <button class="btn btn-primary" type="button"  data-toggle="modal" data-target="#viewggn"><i class="fa fa-search"></i></button>
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <i class="fa fa-search"></i> Penyebab Gangguan
                            </div>
                            <div class="card-body">
					<div class="form-group">
   ...
   <select class="form-control"  name="UP32" id="UP32">
    ...
    &nbsp;&nbsp;&nbsp;
    <br><select class="form-control"  name="ULP2" id="ULP2">
	<option value="0" selected disabled>- Pilih ULP -</option>
	</select>
    <br>
    <br>
	</div>
...
<div class="col-lg-12">			  
   <div class="input-group">		 
   <select class="form-control"  name="fgtm" id="fgtm">
...
var toptenCanvas = document.getElementById("topten");
var totalfeederData = {
  label: 'top 20',
...
var toptenChart = new Chart(toptenCanvas, {
  type: 'horizontalBar',
  data: feedData,
  options: options
