<?php
	...
	if(isset($_GET['bulan']) && $_GET['bulan'] != '')
	{
		...
		$sql = "select data, value from chart where type =".$_GET['bulan'];
		$sql2 = "select siang, malam from loadcurve where month (tanggal)= '".$_GET['bulan']."' AND  year (tanggal)= '".$_GET['tahun']."' ";
