...
if ($login_role == "admin") {
$query="SELECT*
FROM master WHERE 1 ORDER by idarea" ;
...
if (!$result) {
 ...
 echo '  
                             <tr>  
	<td><p data-placement="top" data-toggle="tooltip" title="Lihat"><a href="#modView1" class="btn btn-info btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.$row["idgardu"].'"><i class="fa fa-eye"></i></a></p></td>
									<td>'.$row["area"].'</td>  
									<td>'.$row["rayon"].'</td>  
									<td>'.$row["kodegd"].'</td>  
                                    <td>'.$row["alamat"].'</td>  
...
$query="SELECT*
FROM master WHERE idarea ='$login_idarea' ORDER by kodegd" ;
$result = mysql_query($query);
if (!$result) {
  die('Invalid query: ' . mysql_error());
}
...
if (!$result) {
 ...
 echo '  
                             <tr>  
	<td><p data-placement="top" data-toggle="tooltip" title="Lihat"><span><a href="#modView1" class="btn btn-info btn-circle" data-title="Lihat" data-toggle="modal" data-id="'.$row["idgardu"].'"><i class="fa fa-eye"></i></a></span></p></td>
									<td>'.$row["kodegd"].'</td>  
                                    <td>'.$row["alamat"].'</td>  
                                    <td>'.$row["kapasitas"].'</td>  
                                    <td>'.$row["fasa"].'</td>  
	<td><p data-placement="top" data-toggle="tooltip" title="Edit"><a href="#modEdit" class="btn btn-success btn-circle" data-title="Edit" data-toggle="modal" data-id="'.$row["idgardu"].'"><i class="fa fa-pencil"></i></a></p></td>
	<td><p data-placement="top" data-toggle="tooltip" title="Hapus"><a href="#modDelete" class="btn btn-danger btn-circle" data-title="Hapus" data-toggle="modal" data-id="'.$row["idgardu"].'"><i class="fa fa-trash"></i></a></p></td>																	  
                               </tr>  
                               ';	
	}
